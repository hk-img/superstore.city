							...
							<div class="col-sm-12 col-sm-12 col-xs-12 modalI">
								<div class="box-shadow col-md-5">
									...
									<div class="input-group" style="width: 100%;">
										...
										<input id="mobiles" name="unique_id" class="form-control"
											placeholder="Advisor ID" required type="text">
									</div>
									<div class="input-group" style="width: 100%;">
										<div class="input-group-prepend"><span class="input-group-text">
									...
									<div class="col-sm-12 col-sm-12 col-xs-12 text-right paddingZ">
										<div class="forgot-password text-center"><a
												href="<?php echo base_url('forgot-password') ?>">Forgot Your Password
												?</a>
										</div>
									</div>
									<div class="form-group text-center col-sm-12 col-sm-12 col-xs-12"
										...
										<div class="register" style="margin-left: 0;">
											<button type="submit" class="btn-reply margin-zero btn-login" name="login"
												value="login"
												style="background: transparent;border:none;color:#fff">Login</button>
										</div>
									</div>
								</div>
								</div>
