 ...
 <!-- <section class="bg-white" id="about-us">
   <div class="container">
     <div class="row">
       ...
       <div style="visibility: visible; animation-delay: 60ms;" class="col-sm-7 col-md-7 col-xs-12 wow fadeInUp"
         data-wow-delay="60ms">
         <div class="home-about">
           <div class="clearfix"></div>
           <p>Our team is focusing to develop a path of prosperity for past few year. Now, All people are invited to
             change their life and fulfill their dreams by imparting valuable education,prosperity and holistic
             development with our quality and trusted path.</p>
           <p>
             Life-vision is a dais provided to get achievement which is waiting for you.Our services will help people to
             achieve your goal. Our Team always ready to sort out all issue which will be hurdle in your journey.
           </p>
           <p>
             Company-name will ensure that every person will get fruit of his work with honesty. Even though we have
             taken care to include all our products in this website we request you to kindly connected with the website
             for latest updates.
           </p>
           <p>
         </div>
       </div>
       <div style="visibility: visible; animation-delay: 120ms;" class="col-sm-5 col-md-5 col-xs-12 wow fadeInUp"
         data-wow-delay="120ms">
         <div class="home-about-img"><img src="<?php echo $root;?>web_root/images/about-img.png" class="img-responsive">
         </div>
       </div>
     </div>
   </div>
   ...
   <div class="container">
     <div class="row mobile-align" style="display: flex; align-items: center;">
       <div class="col-xl-6 col-lg-7 wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.2s">
         ...
         <div class="section-wraper-one">
           <div class="icon-bx-wraper">
             <div class="icon-bx-md bef1"><a href="javascript:void(0);" class="icon-cell">
           ...
           <div class="icon-bx-wraper style-2 belf2">
             <div class="icon-bx-md bef2"><a href="javascript:void(0);" class="icon-cell">
           ...
           <div class="icon-bx-wraper style-2 left m-b30">
             <div class="icon-bx-md bef3"><a href="javascript:void(0);" class="icon-cell">
       ...
       <div class="col-xl-6 col-lg-5 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.4s">
         <div class="dlab-media"><img src="web_root/images/img5.png" class="move-2" alt=""></div>
       </div>
     </div>
   </div>
 </section>
 <section class="content-inner-2 bg-container">
   <div class="container">
     <div class="row align-items-center">
       <div class="col-xl-6 col-lg-7 wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.2s">
         <div class="section-head style-1">
           <h6 class="sub-title bgl-primary m-b20 text-primary">Our Thinking</h6>
           <h2 class="title">Our Vision and Mision</h2>
         </div>
       </div>
     </div>
     <div class="col-md-12">
       <div class="row mis-vis-row">
         <div class="col-lg-4">
           <div class="our-mission">
             ...
             <div class="mis-text">
               <p>
                 Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam vero perferendis alias cupiditate
                 magnam? Consectetur dolore veritatis tempore nihil ex iste, aut dolor
               </p>
             </div>
           </div>
         </div>
         <div class="col-lg-4">
           <div class="mis-vis-img">
             <img src="web_root/images/mis-vis.png" alt="">
           </div>
         </div>
         <div class="col-lg-4">
           <div class="our-mission">
             <div class="mis-heading vis-heading">
               <h3>Our Vision</h3>
               <i class="fa fa-lightbulb-o" aria-hidden="true"></i>
             </div>
             <div class="mis-text vis-text">
               <p>
                 Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam vero perferendis alias cupiditate
                 magnam? Consectetur dolore veritatis tempore nihil ex iste, aut dolor, v
               </p>
             </div>
           </div>
         </div>
 ...
 <section class="why-us-container">
   <div class="container">
     <div class="row align-items-center">
       <div class="col-xl-6 col-lg-7 wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.2s">
         <div class="section-head style-1">
           <h6 class="sub-title bgl-primary m-b20 text-primary">Why We</h6>
     ...
     <div class="row">
       <div class="col-md-4">
         <div class="icon-bx-wraper style-3 m-b30 box-hover wow fadeInUp">
           <div class="icon-bx-sm radius bgl-primary"><a href="javascript:void(0);" class="icon-cell"><i
       ...
       <div class="col-md-4">
         <div class="icon-bx-wraper style-3 m-b30 box-hover wow fadeInUp">
           <div class="icon-bx-sm radius bgl-primary"><a href="javascript:void(0);" class="icon-cell">
                 ...
                 <div class="grid">
                   <figure class="col-md-6 col-sm-6 col-xs-12 tag-list-img padd0 fgr11">
                     <a class="example-image-link"
                       href="<?php echo base_url(); ?>web_root/images/product_image/<?php echo $all_productValue['image_name']; ?>"
                       data-lightbox="example-set" style="overflow:hidden;">
                       <img class="example-image img-responsive"
                         src="<?php echo base_url(); ?>web_root/images/product_image/<?php echo $all_productValue['image_name']; ?>"
                         alt="product image">
                     </a>
                   </figure>
                 </div>
 ...
 <section id="features">
   <div class="container">
     ...
     <div class="row wrap-feature-two">
       ...
       <div class="col-md-4">
         <img src="<?php echo $root; ?>web_root/images/man.png" class="img-responsive img-feature-two"
   ...
   <div class="modal-content model-responsive" style="">
     <div class="modal-body">
       <button type="button" class="close" data-dismiss="modal"
         style="background:#333; color:#fff; border-radius:50%; padding:4px 8px; position:absolute; right:-15px; top:-15px; opacity:1;">&times;</button>
